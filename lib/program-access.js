...
function programCanSeeResource(user, row) {
  ...
  // NOTE: a pooled peer merely *teaching* this course is deliberately NOT a
  // grant here. That is a course-membership fact, already checked at the top
  // of this function; treating it as targeting would let content addressed to
  // a third program (e.g. Law) leak to Mines/Non-Quota just because they
  // happen to share the course.
  return false;
}
