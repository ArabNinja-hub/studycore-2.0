...
//
// Terms apply to notes/documents, tutorial sheets, past papers and video
// lessons. Lab reports are deliberately EXEMPT: they follow the laboratory
// schedule rather than the teaching term, so forcing a term on them would be
// a fake answer the uploader has to invent.
// =============================================
...
// program course.
const TERMED_CATEGORIES = Object.freeze(new Set(['video', 'document', 'tutorial', 'past_paper']));

// Categories that never carry a term.
const TERM_EXEMPT_CATEGORIES = Object.freeze(new Set(['lab_report', 'announcement', 'quiz', 'assignment']));
...
// Does a resource of this category need a term? Lab reports never do.
...
// ("Past Paper", "Notes", …) and is lower-cased into the sentence.
